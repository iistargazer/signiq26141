...
- [ ] `cargo test --workspace` → 35 passed (confidence floor)
...
> 35 automated tests · Gottesman–Chuang 2001 · Singh et al. 2023 ·
> Weng et al. 2021 · audit-logged

**Narration:**
> "Security from physics. Decisions from statistics. Zero black boxes —
> 35 automated tests, fully audit-logged. SIH26141. Thank you."
...
1. **+40 s — Audit trail & reproducibility (after Scene 6):** open
   `qds_events.jsonl` in Notepad beside the browser ("every event you
   just saw was persisted with a timestamp and verdict"), then type seed
...
3. **+15 s — Threshold-goes-wrong demo (after Scene 3):** set base
   ...
   15% after.)
4. **+25 s — Slow teleportation narration (Scene 4):** walk the trace
