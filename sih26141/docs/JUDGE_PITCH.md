...
### CLI fallback (30 seconds)

`cargo run -p main_app` prints the whole QKD pipeline in a terminal. Line:
"same engine, no UI — proves the framework isn't a dashboard veneer."
