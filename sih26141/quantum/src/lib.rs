...
/// Expected QBER ≈ intercept_ratio / 3.
...
mod tests {
    ...
    fn zero_ratio_matches_secure_channel() {
        ...
        let res = simulate_six_state_transmission_ratio(&key, 0.0, &mut StdRng::seed_from_u64(7));
    ...
    fn full_ratio_matches_intercept_resend() {
        let key = make_key(4000, 7);
        let res = simulate_six_state_transmission_ratio(&key, 1.0, &mut StdRng::seed_from_u64(7));
    ...
    fn partial_ratio_yields_intermediate_qber() {
        ...
        let res = simulate_six_state_transmission_ratio(&key, 0.3, &mut StdRng::seed_from_u64(11));
        // Expected ≈ 0.1
